...
Next, BWA needs to be added to our PATH variables. To do so, use the following commands but replace "<username>" with your own user name. 

```
export PATH=$PATH:/home/<username>/software/bwa/
source ~/.bashrc
``` 
